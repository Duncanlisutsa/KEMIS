...
SECRET_KEY = 'django-insecure-m5-6^qv6rw7#_wdqocu!hh^ki6e#uislgr4utg)vhhm+)npld&'
...
KEMIS_PAYBILL_NUMBER = env('KEMIS_PAYBILL_NUMBER', default='400222')
KEMIS_ACCOUNT_NUMBER = env('KEMIS_ACCOUNT_NUMBER', default='183991')
